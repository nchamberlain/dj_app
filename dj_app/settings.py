...
# This will default to "False" if it isn't set in env variables
...
# From the D.O. tutorial referred to at top - False unless it is set to true
DEVELOPMENT_MODE = os.getenv("DEVELOPMENT_MODE", "False") == "True"

# Database
# per referenced tutorial
...
if DEVELOPMENT_MODE is True:
    ...
    if os.getenv("DATABASE_URL", None) is None:
        raise Exception("Your DATABASE_URL environment variable not defined")
    DATABASES = {
